...
public class LonelyTwitterActivityTest extends ActivityInstrumentationTestCase2 {
    ...
    public void testaddTweet(){
        ...
        //test that the editor starts up with te right tweet in it to edit
        Tweet tweet = (tweet) oldTweetsList.getItemAtPosition(0);
        assertEquals(tweet, editBodytext);

        //test that we can edit that tweet

        //test that we can push some kind of save buton for that tweet

        //the new modified tweet text was actutally saved

        //the new modified tweet text is displayed on the other activity

        //clean up our acivities at the end of our tes
